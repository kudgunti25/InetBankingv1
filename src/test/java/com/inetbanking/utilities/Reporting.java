...
public class Reporting extends TestListenerAdapter{
	...
	{
		logger=extent.createTest(tr.getName());//create new entry in the report
		logger.log(Status.FAIL, MarkupHelper.createLabel(tr.getName(),ExtentColor.RED));//Send the passed inofrmation 
		...
		{
			try {
				logger.fail("Screenshot id below:"+logger.addScreenCaptureFromPath(screenshotPath));
